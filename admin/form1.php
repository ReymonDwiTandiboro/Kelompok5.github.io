...
// Cek apakah tipe file yang diupload adalah JPG / JPEG / PNG
    ...
    if(move_uploaded_file($tmp_file, $path)){
      ...
      $query = "INSERT INTO apotek(okl,nama,keterangan,maps,gambar) VALUES('".$ok."','".$nama."','".$ket."','".$maps."','".$nama_file."')";
      // Eksekusi/ Jalankan query dari variabel $query
      $sql = mysqli_query($kon, $query);
      if($sql){
        // Jika Sukses, Lakukan :   
        header("location: hokya.php"); // Redirectke halaman index.php
      }
    }
    else{
  ...
  <div class="row"><center>
    <div class="col-md-6">
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" method="post" action="form1.php" enctype="multipart/form-data">
            <div class="form-group">
              <label for="exampleInputEmail1">Nama Apotek</label>
              <input type="text" class="form-control" id="exampleInputEmail1"  name="namaapotek" placeholder="nama apotek">
            </div>
             <div class="form-group">
              <label for="exampleInputEmail1">Keterangan</label>
              <input type="text" class="form-control" id="exampleInputEmail1"  name="keterangan" placeholder="keterangan">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Maps</label>
              <input type="text" class="form-control" id="exampleInputPassword1" name="maps" placeholder="link maps">
            </div>
            <div class="form-group">
              <label for="exampleInputFile">Foto Apotek</label>
              <input type="file" name="gambar" id="exampleInputFile" class="form-control">
