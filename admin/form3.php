...
$bidang = $_POST['kt'];
$jam = $_POST['mft'];
$hari = $_POST['dgn'];// Set path folder tempat menyimpan gambarnya
// Cek apakah tipe file yang diupload adalah JPG / JPEG / PNG
    ...
    if(!empty($nama)){
      ...
      $query = "INSERT INTO obat(okl,obat,golongan,kategori,manfaat,digunakan) VALUES('".$ok."','".$asal."','".$nama."','".$bidang."','".$jam."','".$hari."')";
  ...
  <div class="row"><center>
    <div class="col-md-6">
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" method="post" action="form3.php" enctype="multipart/form-data">
            <div class="form-group">
              <label for="exampleInputEmail1">Nama Obat</label>
              <input type="text" class="form-control" id="exampleInputEmail1"  name="nm" placeholder="Asal Dokter">
            </div>
             <div class="form-group">
              <label for="exampleInputEmail1">Golongan Obat</label>
              <input type="text" class="form-control" id="exampleInputEmail1"  name="gl" placeholder="Nama Dokter">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Keterangan Obat</label>
              <input type="text" class="form-control" id="exampleInputPassword1" name="kt" placeholder="Bidang dokter">
            </div>
            <div class="form-group">
              <label for="exampleInputFile">Manfaat Obat</label>
               <input type="text" class="form-control" id="exampleInputPassword1" name="mft" placeholder="Jam Dokter">
            </div>
           <div class="form-group">
              <label for="exampleInputFile">Digunakan</label>
               <input type="text" class="form-control" id="exampleInputPassword1" name="dgn" placeholder="Hari kerja">
            </div>
